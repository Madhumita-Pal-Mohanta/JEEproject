...
public class EmpDAO 
{
	...
	public boolean updateRecord(EmpInfoModel eobj)
	{
      ...
      try 
      {
		...
		String sqlquery = "update emp1 set name = ? ,salary =?,city =? where email = ?   ";
	...
	public ArrayList<EmpInfoModel> searchEmpRecord(String searchemail){
		Connection mysqlconnectionobj = null;  
		  PreparedStatement pst = null;
		  ResultSet rs = null;
		
		  ArrayList<EmpInfoModel> searchemplist = new ArrayList<EmpInfoModel>();
		  try 
	      {
			mysqlconnectionobj = MySQLDBConnect.getMySQLConnection();
				
			String sqlquery = "select * from emp1 where email = ?";
	...
	public boolean deleteRecord(String deleteemail)
	{
	  Connection mysqlconnectionobj = null;  
	  PreparedStatement pst = null;
